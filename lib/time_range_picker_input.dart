...
import 'package:time_range_picker/time.dart';
...
class _TimeRangePickerState extends State<TimeRangePicker> {
  ...
  Widget buildTimeFrame(BuildContext context) {
    ...
    TextStyle? textStyle = Theme.of(context)
        .textTheme
        .subtitle2?.copyWith(color: isCollapse ? Theme.of(context).primaryColor : Colors.black87, fontSize: 15);
    Widget timeText = Row(
      children: <Widget>[
      ...
      child: AbsorbPointer(
        ...
        child: GestureDetector(
          ...
          child: Container(
            ...
            //(reverse ? Colors.blue : Colors.orange).withOpacity(0.4),
            child: Row(
